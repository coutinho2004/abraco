...
/************************************************************************/
	public static $layout; // recebera o nome do layout na instaciação
/************************************************************************/
	public static $loteCounter = 1; // contador de lotes
/************************************************************************/
	public static $lines; // mantem os dados passados em $data na instaciação
/************************************************************************/
...
/************************************************************************/
	public function __construct($conteudo){
		...
		if ($codigo_tipo == '1') {
			throw new Exception("Esse é um arqvuio de remessa, não pode ser processado aqui.");
		}
