						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<td style="<?php echo $iconeStyle;?>"><?php echo $this->fbradesco->poeZero(11,$b['sacado_cpf_cnpj'])?> <i class="<?php echo $icone?>" aria-hidden="true"></i></td>
									...
									<td><?php echo date('d/m/Y', strtotime($b['data_vencimento'])); ?></td>
