...
<html>
	<head>
		...
		<script src="<?php echo site_url('resources/js/jquery.maskMoney.min.js');?>"></script>
		<!-- DataTables -->
					...
					<ul class="sidebar-menu">
						...
						<li>
							...
							<ul class="treeview-menu">
								<li class="active">
									<a href="<?php echo site_url('index.php/boleto');?>"><i class="fa fa-list-alt"></i> Listar</a>
								</li>
								<li>
									<a href="<?php echo site_url('index.php/boleto/findAluno');?>"><i class="fa fa-plus-circle"></i> Criar</a>
								</li>
							</ul>
						</li>
						<li>
							...
							<ul class="treeview-menu">
								<li class="active">
									<a href="<?php echo site_url('index.php/cnab/geraremssa');?>"><i class="fa fa-cloud-upload" aria-hidden="true"></i> Remessa</a>
								</li>
								<!--<li>
									<a href="<?php echo site_url('index.php/cnab/findRetorno');?>"><i class="fa fa-cloud-download" aria-hidden="true"></i> Retorno</a>
								</li>-->
								<li>
									<a href="<?php echo site_url('index.php/cnab/listaRemessa');?>"><i class="fa fa-folder-open" aria-hidden="true"></i> Listar arquivos Remessa</a>
								</li>
							</ul>
						</li>
						<?php if ($this->ion_auth->is_admin()):?>
						<li>
							<a href="<?php echo site_url('index.php/auth/index');?>">
								<i class="fa fa-key" aria-hidden="true"></i> <span>Gerenciar Usuário</span>
							</a>
						</li>
						<?php endif?>
						<li>
							<a href="<?php echo site_url('index.php/auth/logout')?>">
