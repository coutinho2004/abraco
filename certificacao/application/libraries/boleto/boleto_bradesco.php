...
$data_venc = date("d/m/Y", strtotime($this->data_vencimento));  // Prazo de X dias OU informe data: "13/04/2006";
...
//NOME DO ARQUIVO
$dadosboleto["title"] = "{$this->sacado['snqc']}_{$this->sacado['nome']}_";

// DADOS DO SEU CLIENTE
$dadosboleto["sacado"] = "{$this->sacado['nome']} - CPF: {$this->sacado['cpf_cnpj']}";
$dadosboleto["endereco1"] = $this->sacado['endereco'];
$dadosboleto["endereco2"] = "{$this->sacado['cidade']}, {$this->sacado['uf']} -  CEP: {$this->sacado['cep']} -  E-mail: {$this->sacado['email']}";
