 ...
 * Lay-out para Cobrança com Registro e sem Registro com Emiss�o do Boleto pelo
 * Banco ou pela Empresa
 * Descrição de Registro - Tamanho 400 Bytes
 * A - Alfanumérico - Conte�do em Caixa Alta (Letras Mai�sculas)
 * N - Numérico
 */
...
/************************************************************/
	public function setNome_empresa($nome_empresa) {
		$length = (int) strlen(substr($nome_empresa,0,30));

		if($length > 0 && $length <= 30) {
			$this->nome_empresa = $this->montar_branco($this->retirarAcento($nome_empresa), 30, 'right');
		}else {
